...
from mgallery.services.thumbnails import create_thumbnails, get_duplicates_chunks


class TestGetDuplicatesChunks:
    @patch("mgallery.services.thumbnails.Database")
...
class TestCreateThumbnails:
    @patch("mgallery.services.thumbnails.create_thumbnail")
